...
const isGraphmlUrl = (data: DataSource): data is GraphmlUrl =>
  data.type === DataSourceKind.graphmlUrl;
const isGraphmlString = (data: DataSource): data is GraphmlString =>
  data.type === DataSourceKind.graphmlString;
